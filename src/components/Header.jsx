...
export default function Header() {
    return (
        <div className="w-full">
            <div className="navbar bg-white h-0.5">
                <div className="flex w-33">
                    <div className="flex bg-red-600 w-33 h-16 items-center justify-center -mx-2">
                        <svg viewBox="0 0 97 24" xmlns="http://www.w3.org/2000/svg" width="97" role="presentation" data-testid="NintendoRacetrackLogoIcon" size="97" color="currentColor">
                ...
                <div className='flex items-center gap-1 mr-5'>
                    ...
                    <div className="p-6">
                        <ProfileButton onClick={() => alert("Perfil clickeado")} />
                    </div>
                    <div>
            ...
            {/* SubNavbar */}
            <div className='navbar flex items-center justify-center bg-gray-100'>
                <SubNavbar />
            </div>
        </div>
    )
